...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 backgroundBg pb-10 pt-10 lg:pb-20 lg:pt-[80px]">
              ...
              <div className="mb-10 w-full">
                ...
                <div className="mb-6 flex items-center">
                  <a
                    ...
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:hover:border-green-700 hover:bg-green-700 hover:text-white dark:border-dark-3 dark:text-white dark:hover:hover:border-green-700 sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="8"
                      height="16"
                ...
                </div>
                {
                  <p className="text-base text-body-color dark:text-dark-6">
                    &copy; {new Date().getFullYear()} GreenNest | All right
                    reserved.
                  </p>
                }
              </div>
